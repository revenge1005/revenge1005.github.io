---
title:  "[KUBERNETES] 15-1. 온프레미스 환경에서 SDS에 의한 동적 프로비저닝 (GlusterFS + Heketi)" 
...
---
# [KUBERNETES] 15-1. 온프레미스 환경에서 SDS에 의한 동적 프로비저닝 (GlusterFS + Heketi)
---
...
Clusters:
Id:01d0b370f8ddf1dab4fd88322a3848c4 [file][block]

$ heketi-cli node list
Id:0e6787e15146f11343d732b9ee519c94     Cluster:01d0b370f8ddf1dab4fd88322a3848c4
Id:dfc9adb624ad2e0ff82aebdee697daeb     Cluster:01d0b370f8ddf1dab4fd88322a3848c4
```

#### (e-2) heketi-cli node info 명령어를 통해 노드 정보 확인

```bash
$ heketi-cli node info 0e6787e15146f11343d732b9ee519c94
Node Id: 0e6787e15146f11343d732b9ee519c94
State: online
Cluster Id: 01d0b370f8ddf1dab4fd88322a3848c4
Zone: 1
Management Hostname: gluster01
Storage Hostname: gluster01
Devices:

$ heketi-cli node info dfc9adb624ad2e0ff82aebdee697daeb
Node Id: dfc9adb624ad2e0ff82aebdee697daeb
State: online
Cluster Id: 01d0b370f8ddf1dab4fd88322a3848c4
Zone: 1
