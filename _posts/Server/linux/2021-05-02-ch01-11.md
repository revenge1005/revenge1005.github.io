...
## 2-1. useradd / usermod : 사용자 계정 생성 / 사용자 계정의 설정 변경
...
## 2-2. passwd : 사용자 계정의 패스워드 생성 및 설정 변경

<br>

## 2-3. chage : 사용자 계정의 패스워드 설정 변경

<br>

## 2-4.  userdel : 사용자 계정 삭제 (-r : 홈 디렉토리 까지 삭제)

<br>

## 2-5. groups : 사용자 그룹의 정보 확인

<br>

## 2-6. groupadd : 사용자 그룹 생성

<br>

## 2-7. groupmod : 사용자 그룹의 설정 변경
...
## 2-8. gpasswd : 사용자 그룹의 PW 설정 / 관리자 지정 및 추가 / 멥버 추가 및 삭제
...
## 2-9.  su : 다른 사용자 계정으로 전환

<br>

## 2-10.  sudo : 현재 사용자 계정에서 root 권한을 이용하여 명령어를 실행
...
## 3-1. users : 시스템에 로그인되있는 사용자의 아이디 출력

<br>

## 3-2. who / w : 시스템에 로그인되있는 사용자를 출력

<br>

## 3-3. whoami : 실질적 권한자를 출력

<br>

## 3-4. logname : 사용자의 로그인 계정을 출력

<br>

## 3-5.  groups : 사용자가 속한 그룹명 출력

<br>

## 3-6. lslogins : 시스템 전체 사용자의 정보를 출력

<br>

## 3-7. id : 아이디에 대한 정보를 출력
