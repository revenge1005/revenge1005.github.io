...
![01-1](https://user-images.githubusercontent.com/42735894/232210005-f82705af-c678-4ce0-8103-04ea90a18164.PNG){: width="70%" height="70%"}{: .align-center}

![02](https://user-images.githubusercontent.com/42735894/232210003-d2224bcf-beb5-4ded-b4cd-0a69cae86b2e.PNG){: width="70%" height="70%"}{: .align-center}
...
+ 호스트 이름, 사용자 이름, 사용자 암호를 입력한 다음 [로그인] 버튼을 클릭

![03](https://user-images.githubusercontent.com/42735894/232214981-002e4c99-ffc3-4ea2-9f99-3a3e3f16c43e.PNG){: width="70%" height="70%"}{: .align-center}

+ 인증에 성공하면 SSH를 통해 WinSCP에서 파일을 전송할 수 있습니다.

![04](https://user-images.githubusercontent.com/42735894/232214989-5d24fcd2-91c5-4ca6-b81b-98a3e1e8fd6e.PNG){: width="70%" height="70%"}{: .align-center}
...
+ [Puttygen.exe]를 실행한 후 다음 창에서 [Load] 버튼을 클릭합니다.

![1](https://user-images.githubusercontent.com/42735894/232234483-0447c50f-cf28-4c31-bacb-98cef490db27.PNG){: width="70%" height="70%"}{: .align-center}

<br>

+ [Save private key] 버튼을 클릭하여 원하는 파일 이름으로 원하는 폴더에 저장합니다.

![2](https://user-images.githubusercontent.com/42735894/232234484-eb47789a-bf86-4dc2-81c1-c4a3b764fd08.PNG){: width="70%" height="70%"}{: .align-center}
...
+ Connection > Data > Login-details에서 SSH 키를 설정한 계정을 입력한다.
...
+ Connection > SSH > Auth로 이동한 다음 Private key file for authentication에 Browse 버튼을 클릭한 다음 저장한 Private key를 선택

![5](https://user-images.githubusercontent.com/42735894/232234798-fef0059d-1fe2-4b96-8b57-6ad2f57aa8fe.PNG){: width="70%" height="70%"}{: .align-center}

<br>

+ Session으로 돌아와서 (옵션을 Save를 하십쇼) 접속한다.
